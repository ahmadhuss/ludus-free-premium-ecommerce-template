                                ...
                                <div class="u-s-p-y-60">
                                    ...
                                    <ul class="shop-p__pagination">
                                        <li class="is-active">
                                            ...
                                            <a href="shop-list-right.html">1</a></li>
                                        <li>

                                            <a href="shop-list-right.html">2</a></li>
                                        <li>

                                            <a href="shop-list-right.html">3</a></li>
                                        <li>

                                            <a href="shop-list-right.html">4</a></li>
                                        <li>

                                            <a class="fas fa-angle-right" href="shop-list-right.html"></a></li>
                                    </ul>
                                    <!--====== End - Pagination ======-->
                                </div>
                            </div>
